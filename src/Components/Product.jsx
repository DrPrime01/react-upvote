...
function Product({productDesc, productImgUrl, productTitle, productOwnerImg, productVotes, increaseVote, productId}) {
  ...
  return (
    <div className='d-flex p-4 mb-3 border border-light rounded'>
      <div className="me-5">
        <img src={productImgUrl} alt="product" className="img-fluid" height={150} width={150}/>
      </div>
      <div className='product-info-container'>
        ...
        <div className='lower-aligned-content'>
            ...
            <img src={ productOwnerImg } alt="product-owner" className='img-fluid rounded-circle' height={30} width={30}/>
        </div>
      </div>
    </div>
  )
